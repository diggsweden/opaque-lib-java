...
class OpaqueUtilsTest {
  ...
  void concatTest() throws Exception {
    ...
    String strings =
        new String(OpaqueUtils.concat("Stringa-", "Stringb-", "Stringc"), StandardCharsets.UTF_8);
  ...
  void xorTest() throws Exception {
    ...
    /*
     * 01 82 : 0000 0001 1000 0010 11 45 : 0001 0001 0100 0101 --------------------------- XOR 10 c7
     * : 0001 0000 1100 0111
     */
  ...
  void splitTest() throws Exception {
    ...
    log.info("Split 1: {}, slit 2: {}", Hex.toHexString(split.get(0)),
        Hex.toHexString(split.get(1)));
  ...
  void os2ipTest() throws Exception {
    ...
    BigInteger longInt =
        OpaqueUtils.os2ip(Hex.decode("10 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ff"));
  ...
  private void checkRandomness(byte[] random, int deviation) throws IOException {
    ...
    log.info("Lowest char count: {}, highest: {} - Difference: {}", lowest, highest,
        highest - lowest);
