...
public abstract class AbstractOprfFunction implements OprfFunctions {
  ...
  @Override
  public KeyPair getKeyPair(KeyPairRecord keyPairRecord)
      throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException,
      DeserializationException {
    return new KeyPair(getPublicECKey(keyPairRecord.publicKey()),
        getPrivateECKey(keyPairRecord.privateKey()));
  }

  @Override
  public byte[] serializeElement(ECPoint element) {
    return opaqueCurve.serializeElement(element);
  }

  @Override
  public int getOPRFSerializationSize() {
    return opaqueCurve.getElementSerializationSize();
  }

  @Override
  public ECPoint deserializeElement(byte[] elementBytes) throws DeserializationException {
  ...
  @Override
  public int getOprfPrivateKeySize() {
  ...
  protected byte[] deriveYCoordinate(byte[] sharedSecret, byte[] controlX, PublicKey publicKey)
    ...
    return deriveYCoordinate(sharedSecret, controlX,
        deserializeElement(serializePublicKey(publicKey)));
  }
  ...
  @Override
  public PrivateKey getPrivateECKey(byte[] privateKeyBytes)
      throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
    return OpaqueUtils.getPrivateECKey(privateKeyBytes, opaqueCurve.getParameterSpec());
  }

  @Override
  public PublicKey getPublicECKey(byte[] publicKeyBytes)
