 ...
 * offline attack upon the compromise of the credential file at the server. Applications SHOULD
 * select parameters for the KSF that balance cost and complexity across different client
 * implementations and deployments. Note that in OPAQUE, the key stretching function is executed by
 * the client, as opposed to the server in traditional password hashing scenarios. This means that
