 ...
 * authentication tag. This data type is defined in OPAQUE.
 *
...
public record Envelope(
   ...
   */
  public static Envelope fromBytes(byte[] envelopeBytes, int nonceLength)
  ...
  /**
   * Returns the encoded representation of this {@code Envelope}. This representation is formed by
   * concatenating the {@code nonce} and the {@code authTag} fields.
   *
